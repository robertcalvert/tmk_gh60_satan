/*
Copyright 2016 Robert Calvert <robert.calvert.io>
...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LSFT,NUBS,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,     RSFT, NO,
    ...
    TAB, Q,  UP,   E,   R,   T,   CALC,   U,   INS,   O,PSCR,   SLCK,BRK, NO,
    CAPS,LEFT,DOWN,RIGHT,F,   G,   H,   J,   K,   L,   HOME,PGUP,NUHS,ENT,
    LSFT,NUBS,Z,   APP,   C,   V,   B,   VOLD,   VOLU,   MUTE ,END, PGDN, RSFT, NO,
    LCTL,LGUI,LALT,          SPC,                     RALT,FN0,FN1, RCTL
    ),
    ...
    KEYMAP(
    GRV,F1,  F2,  F3,  F4,  F5,  F6,  F7,  F8,  F9, F10,   F11,F12, DEL, NO,
    TAB, Q,  UP,   E,   R,   T,   CALC,   U,   INS,   O, FN2,   SLCK,BRK, NO,
    CAPS,LEFT,DOWN,RIGHT,F,   G,   H,   J,   K,   L,   HOME,PGUP,NUHS,ENT,
    LSFT,NUBS,Z,   APP,   C,   V,   B,   VOLD,   VOLU,   MUTE ,END, PGDN, RSFT, NO,
    LCTL,LGUI,LALT,          SPC,                     RALT,FN0,FN1, RCTL
    ),
